 ...
 */
@Stable
class HeatMapCalendarState<VisibleItemState> internal constructor(
    ...
    companion object {
        internal val Saver: Saver<HeatMapCalendarState<Any?>, Any> = listSaver(
            save = {
